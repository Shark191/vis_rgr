...
#pragma warning disable IDE0051 // Удалите неиспользуемые закрытые члены
        ...
        private void NewScheme() {
            ...
            button2.Command.Execute(null); Устарело*/
        }
        private void ImportScheme(string data) {
            ...
            Scheme clone = new(proj, "test", yeah);
            ...
            map.ImportScheme(mainWindow.mwvm.canv ?? new(), true);
        }
        ...
        private string ComplexSolution(bool lol = false) {
            ...
            for (int step = 0; step < steps; step++) {
                ...
                int hits = 0;
                Ticks(1);
                while (++hits < 128 && sim.SomethingHasChanged) Ticks(1);
        ...
        public void GeneralTest() {
            ...
            Assert.NotNull(gate);
            var data = Export();
            Assert.Equal("{\"name\": \"Newy\", \"created\": 123, \"modified\": 456, \"items\": [{\"id\": 0, \"pos\": \"$p$200,200\", \"size\": \"$s$90,90\"}], \"joins\": [], \"states\": [false, false]}", data);
            ...
            data = Export();
            Assert.Equal("{\"name\": \"Newy\", \"created\": 123, \"modified\": 456, \"items\": [{\"id\": 0, \"pos\": \"$p$200,200\", \"size\": \"$s$90,90\"}, {\"id\": 3, \"pos\": \"$p$300,300\", \"size\": \"$s$90,90\"}], \"joins\": [], \"states\": [false, false, false]}", data);
            ...
            Assert.Equal("01000|01000|11011|10111|01110|11111|00110|01010", sb.ToString());
            ...
            Assert.Equal("000000_t1|100111_t3|111001_t3|111100_t3|101010_t3|000110_t3|110011_t3|111010_t3|000101_t3|101101_t3|001111_t3|111000_t3|000101_t4|011000_t3|001001_t3|000110_t3", res);
            ...
            res = ComplexSolution();
            Assert.Equal("0100111111111_t128|1100111101010_t128|1100101110000_t128|1111000101111_t128|1011010011011_t128|1001100001001_t128|1111000000011_t128|0111000011010_t128|1101001111100_t128|1010101110100_t128|1000101111110_t128|1000001000001_t128|0110111100011_t128|1010001101000_t128|1100001010010_t128|1000101000001_t128|0101001001000_t128|0011001001001_t128|0110010001100_t128|0111010001110_t128|0101011011010_t128|0111011111001_t128|0100001011001_t128|1010001100100_t128|1100110111011_t128|0001010010111_t128|1111010101001_t128|0000011001110_t128|1110001011110_t128|0011110100000_t128|0101100010110_t128|1100100010111_t128", res);
            ...
            res = ComplexSolution();
            Assert.Equal("10101_t1|11001_t1|00101_t1|00001_t1|00000_t1|10001_t1|01001_t1|11110_t1|01010_t1|01101_t1|00010_t1|11100_t1|01010_t1|00110_t1|01011_t1|01011_t1|10100_t1|00010_t1|10111_t1|01001_t1|10011_t1|01100_t1|10100_t1|01010_t1|01111_t1|00100_t1|10011_t1|00111_t1|01010_t1|00001_t1|11101_t1|00000_t1", res);
            ...
            res = ComplexSolution();
            Assert.Equal("011110_t1|000101_t1|011110_t1|010111_t1|111101_t1|011011_t1|100010_t1|101100_t1|000101_t1|000011_t1|110010_t1|001010_t1|011100_t1|000001_t1|101010_t1|011010_t1|100010_t1|000110_t1|100111_t1|000011_t1|100111_t1|100111_t1|111010_t1|111001_t1|011110_t1|111111_t1|010100_t1|010000_t1|000110_t1|001000_t1|110110_t1|000000_t1", res);
        }
    }
}